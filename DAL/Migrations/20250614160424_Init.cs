        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalityAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    NationalityEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbAuthor", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WebsiteNameAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    WebsiteNameEn = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    AddressAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TbBook_TbAuthor_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "TbAuthor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbBook_TbCategory_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbFavoriteBook", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TbFavoriteBook_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbFavoriteBook_TbBook_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbReport", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TbReport_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbReport_TbBook_BookId",
                        column: x => x.BookId,
                        principalTable: "TbBook",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TbReview", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TbReview_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TbReview_TbBook_BookId",
                        column: x => x.BookId,
                        principalTable: "TbBook",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TbBook_AuthorId",
                table: "TbBook",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_TbBook_CategoryId",
                table: "TbBook",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_TbFavoriteBook_BookId",
                table: "TbFavoriteBook",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_TbFavoriteBook_UserId",
                table: "TbFavoriteBook",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TbReport_BookId",
                table: "TbReport",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_TbReport_UserId",
                table: "TbReport",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TbReview_BookId",
                table: "TbReview",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_TbReview_UserId",
                table: "TbReview",
                column: "UserId");
        }
